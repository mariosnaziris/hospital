...
$sql_query = 'SELECT Name,Surname,Imerominia,Date_Time_id, Time FROM patients INNER JOIN appointment USING(Patient_id)INNER JOIN schedule USING (Date_Time_id) INNER JOIN hour USING(Time_id) WHERE  Imerominia="'.$today.'" AND Doctor_id="'.$_GET['id'].'" ORDER BY Imerominia,Time';
...
<br/>
<h6><span class="style1">Ραντεβού Ημέρας</span></h6>
<br/>


<form name="form1" method="post" action="Rantevou.php?id=<?php echo $_GET['id']; ?>">
